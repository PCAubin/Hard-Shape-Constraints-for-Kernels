...
% To reproduce Table 1 for the 3D UCI datasets.
...
% Computation should take 50 min with the given parameters for the dataset
% "ufc". As it depends on the total number of points, it varies a
...
% listFiles=1:length(NAMES_3D); %UNCOMMENT TO CONSIDER ALL THE 3D DATASETS
...
disp(strcat("Finished ",NAMES_3D(fileNb)))

if savebool
    saveFileName=['QR_Table_Results_3D.txt'];
